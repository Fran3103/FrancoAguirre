...
const Navbar = () => {
  return (
    <div className='max-w-[1240px] m-auto p-4 mx-4 flex flex-col gap-2 items-center sm:flex-row sm:justify-evenly xl:justify-between bg-black rounded-lg mt-2 lg:mx-12 xl:m-auto lg:mt-2 xl:mt-2'>
